...
}`))}},8918:(e,t,i)=>{i.d(t,{x:()=>h});var r=i(54099),n=i(88321),o=i(30726),a=i(30015),s=i(73146),l=i(87634);const c=["layerObjectAdded","layerObjectRemoved","layerObjectsAdded","layerObjectsRemoved","transformationChanged","shaderTransformationChanged","visibilityChanged","occlusionChanged","highlightChanged","geometryAdded","geometryRemoved","attributesChanged"];var d=i(94536),p=i(44513);class h extends s.J{constructor(e,t){let i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"";super(),this.stage=e,this.apiLayerUid=i,this.type=l.X.Layer,this.events=new r.A,this.visible=!0,this.sliceable=!1,this._objectsAdded=new a.A,this._handles=new n.A,this._objects=new a.A,this._pickable=!0,this.visible=t?.visible??!0,this._pickable=t?.pickable??!0,this.updatePolicy=t?.updatePolicy??p.q.ASYNC,this._disableOctree=t?.disableOctree??!1,e.add(this);for(const r of c)this._handles.add(this.events.on(r,(t=>e.handleEvent(r,t))))}destroy(){this._handles.size&&(this._handles.destroy(),this.stage.remove(this),this.invalidateSpatialQueryAccelerator())}get objects(){return this._objects}set pickable(e){this._pickable=e}get pickable(){return this._pickable&&this.visible}add(e){this._objects.push(e),e.parentLayer=this,this.events.emit("layerObjectAdded",{layer:this,object:e}),null!=this._octree&&this._objectsAdded.push(e)}remove(e){this._objects.removeUnordered(e)&&(e.parentLayer=null,this.events.emit("layerObjectRemoved",{layer:this,object:e}),null!=this._octree&&(this._objectsAdded.removeUnordered(e)||this._octree.remove([e])))}addMany(e){this._objects.pushArray(e);for(const t of e)t.parentLayer=this;this.events.emit("layerObjectsAdded",{layer:this,objects:e}),null!=this._octree&&this._objectsAdded.pushArray(e)}removeMany(e){const t=new Array;if(this._objects.removeUnorderedMany(e,e.length,t),0!==t.length){for(const e of t)e.parentLayer=null;if(this.events.emit("layerObjectsRemoved",{layer:this,objects:t}),null!=this._octree){for(let e=0;e<t.length;)this._objectsAdded.removeUnordered(t[e])?(t[e]=t[t.length-1],t.length-=1):++e;this._octree.remove(t)}}}sync(){this.updatePolicy!==p.q.SYNC&&this.stage.syncLayer(this.id)}notifyObjectBBChanged(e,t){null==this._octree||this._objectsAdded.includes(e)||this._octree.update(e,t)}getSpatialQueryAccelerator(){return null==this._octree&&this._objects.length>50&&!this._disableOctree?(this._octree=new d.A((e=>e.boundingVolumeWorldSpace.bounds)),this._octree.add(this._objects.data,this._objects.length)):null!=this._octree&&this._objectsAdded.length>0&&(this._octree.add(this._objectsAdded.data,this._objectsAdded.length),this._objectsAdded.clear()),this._octree}invalidateSpatialQueryAccelerator(){this._octree=(0,o.pR)(this._octree),this._objectsAdded.clear()}}},14623:(e,t,i)=>{i.d(t,{R:()=>C,b:()=>x,r:()=>R});var r=i(34981),n=i(26917),o=i(90080),a=i(3838),s=i(56906),l=i(17698),c=i(36324),d=i(94192),p=i(80883),h=i(3799),u=i(28450),f=i(51596),m=i(58350),v=i(23148),g=i(21390),S=i(86955),_=i(23687),T=i(66470),y=i(50125),O=i(91911),E=i(46259),b=i(2687),A=i(75569);const R=1;function x(e){const t=new b.N5,{attributes:i,varyings:x,vertex:C,fragment:D}=t,{applyMarkerOffset:L,draped:I,output:P,capType:N,stippleEnabled:w,falloffEnabled:W,roundJoins:U,wireframe:z,innerColorEnabled:F}=e;t.include(c.p),t.include(a.s,e),t.include(s.q,e),t.include(o.g,e),t.include(d.Z,e);const j=L&&!I;j&&(C.uniforms.add(new g.m("markerScale",(e=>e.markerScale))),t.include(l.r,{space:y.lM.World})),(0,h.NB)(C,e),C.uniforms.add(new _.F("inverseProjectionMatrix",(e=>e.camera.inverseProjectionMatrix)),new u.E("nearFar",(e=>e.camera.nearFar)),new g.m("miterLimit",(e=>"miter"!==e.join?0:e.miterLimit)),new f.I("viewport",(e=>e.camera.fullViewport))),C.constants.add("LARGE_HALF_FLOAT","float",65500),i.add(T.r.POSITION,"vec3"),i.add(T.r.PREVPOSITION,"vec3"),i.add(T.r.NEXTPOSITION,"vec3"),i.add(T.r.SUBDIVISIONFACTOR,"float"),i.add(T.r.UV0,"vec2"),x.add("vColor","vec4"),x.add("vpos","vec3"),x.add("vLineDistance","float"),x.add("vLineWidth","float");const H=w;H&&x.add("vLineSizeInv","float");const M=N===E.x.ROUND,V=w&&M,B=W||V;B&&x.add("vLineDistanceNorm","float"),M&&(x.add("vSegmentSDF","float"),x.add("vReverseSegmentSDF","float")),C.code.add(S.H`vec2 perpendicular(vec2 v) {
return vec2(v.y, -v.x);
}
...
finalColor.a *= 1.0 - clamp(feather, 0.0, 1.0);`)),D.main.add(S.H`outputColorHighlightOID(finalColor, vpos);`),t}const C=Object.freeze(Object.defineProperty({__proto__:null,build:x,ribbonlineNumRoundJoinSubdivisions:R},Symbol.toStringTag,{value:"Module"}))},17698:(e,t,i)=>{i.d(t,{r:()=>l});var r=i(99443),n=i(3799),o=i(23148),a=i(86955),s=i(50125);function l(e,t){const i=e.vertex;(0,n.Nz)(i),null==i.uniforms.get("markerScale")&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",r.PV).code.add(a.H`float getLineWidth() {
